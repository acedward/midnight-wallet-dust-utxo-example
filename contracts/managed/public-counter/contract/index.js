...
export class Contract {
      ...
      incrementBy: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('incrementBy',
                                     ...
                                     'public-counter.compact line 11 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = this._incrementBy_0(context, partialProofData, n_0);
      ...
      reset: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('reset',
                                     'argument 1 (as invoked from Typescript)',
                                     'public-counter.compact line 15 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
  ...
  initialState(...args_0) {
    ...
    if (!(typeof(initial_0) === 'bigint' && initial_0 >= 0n && initial_0 <= 65535n)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'public-counter.compact line 7 char 1',
                                 'Uint<0..65536>',
                                 initial_0)
    }
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { addi: { immediate: parseInt(__compactRuntime.valueToBigInt(
                                                              { value: _descriptor_0.toValue(initial_0),
                                                                alignment: _descriptor_0.alignment() }
                                                                .value
                                                            )) } },
                                       { ins: { cached: true, n: 1 } }]);
  ...
  _incrementBy_0(context, partialProofData, n_0) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
